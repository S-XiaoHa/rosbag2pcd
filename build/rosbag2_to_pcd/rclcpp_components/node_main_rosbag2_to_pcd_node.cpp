...
#define NODE_MAIN_LOGGER_NAME "rosbag2_to_pcd_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "librosbag2_to_pcd_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rosbag2_to_pcd::Rosbag2ToPcdNode>";
